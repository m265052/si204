    ...
    int main()
    {
        ...
        //hunter array only needs to be a single * bc only one hunter per Z
        Hunt* packs = new Hunt[Zs];
        ...
        makeBoard(rows, cols, bo.B, fin, bo, fleet, packs);
        ...
        do {
            ...
            kb = inputChar();
            move(rows, cols, bo, kb, brk, strack, numZs, fleet, packs);
